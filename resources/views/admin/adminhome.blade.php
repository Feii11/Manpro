...
<div class="container mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <a href="{{ route('admin.users') }}" class="block p-4 bg-green-500 text-white rounded-md">View Users</a>
        <a href="{{ route('admin.admins') }}" class="block p-4 bg-purple-500 text-white rounded-md">View Admins</a>
